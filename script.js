$(document).ready(function(){
	...
	$('.todo a.delete').live('click',function(){
        ...
        ///////////////////////////////////////////////////
        $('.todo a.updatestatus').live('click',function(){
		$("#dialog-confirm").dialog('open');
	});
        ///////////////////////////////////////////////////
        ///////////////////////////////////////////////////
        $('.todo a.notdone').live('click',function(){
		//$("#dialog-confirm").dialog('open');
                
                $.get("ajax.php",{'action':'updatestatus','id':currentTODO.data('id')});
                currentTODO.fadeOut('fast');
                //doWork();
...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    ...
    document.getElementById("workDone").innerHTML=xmlhttp.responseText;
    //alert(xmlhttp.responseText);
    }
  }
xmlhttp.open("GET","doneList.php",true);
xmlhttp.send();
}